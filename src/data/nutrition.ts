...
const baseMeals: Array<Omit<Meal, 'examples'>> = [
  { id: 'breakfast', name: 'Desayuno', target: 'Bloque 1 del día', proteinSources: ['Huevos enteros'], carbSources: ['Pan integral'], fatSources: ['Yema de huevo', 'palta'], vegetables: [], tips: ['Elige una opción. Ambas respetan el presupuesto de este horario.', 'En la opción B, prepara los huevos revueltos sin aceite y toma el café solo, sin azúcar ni leche.'] },
...
const readyMealExamples: Record<NutritionPlanId, Record<Meal['id'], MealOption[]>> = {
  cut: {
    breakfast: [option('Opción A · Avena y yogur', ['50 g de avena', '200 g de yogur griego natural', '25 g de plátano', '10 g de mantequilla de maní'], 400, 30, 45, 10), option('Opción B · Café, huevos, pan y palta', ['Café solo, sin azúcar ni leche', '2 huevos enteros (100 g), revueltos sin aceite', '85 g de pan integral', '20 g de palta'], 400, 30, 45, 10)],
  ...
  bulk: {
    breakfast: [option('Opción A · Avena completa', ['75 g de avena', '250 g de yogur griego natural', '100 g de plátano', '15 g de mantequilla de maní'], 550, 35, 70, 15), option('Opción B · Café, huevos, pan y palta', ['Café solo, sin azúcar ni leche', '3 huevos enteros (150 g), revueltos sin aceite', '140 g de pan integral', '40 g de palta'], 550, 35, 70, 15)],
  ...
  finalCut: {
    breakfast: [option('Opción A · Avena ligera', ['40 g de avena', '250 g de yogur griego natural', '70 g de plátano', '10 g de mantequilla de maní'], 400, 35, 40, 10), option('Opción B · Café, huevos, pan y palta', ['Café solo, sin azúcar ni leche', '2 huevos enteros (100 g), revueltos sin aceite', '75 g de pan integral', '15 g de palta'], 400, 35, 40, 10)],
